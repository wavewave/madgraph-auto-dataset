module HEP.Automation.MadGraph.Dataset.Set20110224 where
...
axiparamset :: [Param]
axiparamset = [ AxiGluonParam 2000.0 0.0 0.0 1.5 (-1.5) 
              , AxiGluonParam 2000.0 0.0 0.0 (1.5*sqrt 2.0)  (-1.5*sqrt 2.0)
              , AxiGluonParam 2000.0 0.0 0.0 (1.5*2.0) (-1.5*2.0) ]
