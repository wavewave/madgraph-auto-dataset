...
paramSet = [ C1VParam { mnp = m, gnpR = g, gnpL = 0 } 
           | (m,g) <-  drop 10 (map (\x->(300,x)) [0.4,0.45..1.0] )]
--           | (m,g) <- drop 10 (map (\x->(600,x)) [1.0,1.05..1.60] ) ] 


--           | (m,g) <-   take 4 (drop 6 (map (\x->(300,x)) [0.4,0.45..1.0] ))
--                        ++ drop 8 (map (\x->(400,x)) [0.6,0.65..1.10] )
--                        ++ take 3 (map (\x->(400,x)) [1.15,1.20..1.40] )
--                        ++ take 6 (drop 4 (map (\x->(600,x)) [1.0,1.05..1.60] )) 
--                        ++ (map (\x->(800,x)) [1.30,1.35..1.50] ) ]


--                         (map (\x->(200,x)) [0.4,0.45,0.50,0.55,0.60] )
--                      ++ (map (\x->(300,x)) [0.7,0.75..0.85] )
--                      ++ (map (\x->(400,x)) [1.0,1.05..1.25] )
--                      ++ (map (\x->(600,x)) [1.2,1.25..1.45] ) 
--                      ++ (map (\x->(800,x)) [1.6,1.65..1.85] ) ]
