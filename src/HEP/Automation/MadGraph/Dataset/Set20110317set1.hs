module HEP.Automation.MadGraph.Dataset.Set20110317set1 where
...
my_ssetup = SS {
  ...
  , mg5base    = "/Volumes/ramdisk/montecarlo/MG_ME_V4.4.44/MadGraph5_v0_6_1/"
  , workbase   = "/Volumes/ramdisk/workspace/ttbar/mc/"
  }
