module HEP.Automation.MadGraph.Dataset.Set20110502set4 where
...
psetup_zphfull_SingleTZpJDecay = PS {  
  ...
  , workname   = "428ZpH_SingleTZpJDecay"
  }
...
zptasklist ssetup csetup =  
  [ WS ssetup (psetup_zphfull_SingleTZpJDecay) 
       ...
       csetup  
       (WebDAVRemoteDir "mc/TeVatronFor3/ZpHFull0502Big")
