module HEP.Automation.MadGraph.Dataset.Set20110715set4 where
...
processSetup = PS {  
  ...
  , workname   = "715_SChanC8V_TTBar0or1J_TEV"
  }
...
webdavdir = WebDAVRemoteDir "paper3/ttbar_TEV_alvarez_pgsscan"
