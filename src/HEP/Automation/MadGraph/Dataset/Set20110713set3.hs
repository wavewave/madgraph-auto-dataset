module HEP.Automation.MadGraph.Dataset.Set20110713set3 where
...
processSetup = PS {  
  ...
  , workname   = "713_SChanC8V_TTBar0or1J_TEV"
  }

paramSet :: [ModelParam SChanC8V]
paramSet = [ SChanC8VParam { mnp = m, gnpqR = -0.3, gnpqL = 0.3, 
                             gnpbR = g, gnpbL = -g,
                             gnptR = g, gnptL = -g }
...
webdavdir = WebDAVRemoteDir "paper3/ttbar_TEV_schanc8v_pgsscan"
